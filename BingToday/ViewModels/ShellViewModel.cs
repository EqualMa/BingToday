...
using BingToday.Services;
using BingToday.Views;
...
namespace BingToday.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<HomePagePage>("Shell_HomePage".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<GalleryPagePage>("Shell_GalleryPage".GetLocalized(), Symbol.Document));
